...
class HscriptGlobals {
    ...
    //public static var initialZoom(get, never):Float; //this was removed in the HaxeFlixel 5.0.0 update apparently
    ...
    /*static function get_initialZoom():Float { //this was removed in the HaxeFlixel 5.0.0 update apparently
