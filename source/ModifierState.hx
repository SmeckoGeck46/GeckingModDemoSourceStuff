...
class ModifierState extends MusicBeatState
{
	...
	public static var modifiers:Array<TModifier> = [
		...
		*/
		...
		},
		{
			...
			multi: 1,
			times: true,
			desc: "If you wanna edit the song's chart, be my guest."
		},
		{
			name: "Nut button",
			internName: "antijank",
	...
	function toggleSelection() {			
		switch(modifiers[curSelected].internName) {
			...
			case 'antijank': //nut button because why not
