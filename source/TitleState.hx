...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			FlxTransitionableState.defaultTransIn = new TransitionData(FADE, FlxColor.BLACK, 1, new FlxPoint(0, -1), {asset: diamond, width: 96, height: 32},
				new FlxRect(-2000, -2800, FlxG.width * 3, FlxG.height * 3));
			FlxTransitionableState.defaultTransOut = new TransitionData(FADE, FlxColor.BLACK, 0.7, new FlxPoint(0, 1),
				{asset: diamond, width: 96, height: 32}, new FlxRect(-2000, -2800, FlxG.width * 3, FlxG.height * 3));
	...
	override function beatHit()
	{
		...
		if (curBeat < 9) {
			switch (curBeat)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['A modification', 'of']);
				case 7:
